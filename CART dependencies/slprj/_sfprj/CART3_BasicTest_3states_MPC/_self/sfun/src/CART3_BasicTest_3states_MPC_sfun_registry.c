...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_CART3_BasicTest_3states_MPC_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_mpclib_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_CART3_BasicTest_3states_MPC_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_CART3_BasicTest_3states_MPC_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "CART3_BasicTest_3states_MPC") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_CART3_BasicTest_3states_MPC_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_CART3_BasicTest_3states_MPC_third_party_uses_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "CART3_BasicTest_3states_MPC") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_CART3_BasicTest_3states_MPC_third_party_uses_info(nlhs,plhs,3,
      newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_CART3_BasicTest_3states_MPC_updateBuildInfo_args_info
  ...
  if (strcmp(machineName, "CART3_BasicTest_3states_MPC") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_CART3_BasicTest_3states_MPC_updateBuildInfo_args_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_CART3_BasicTest_3states_MPC_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "CART3_BasicTest_3states_MPC") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_CART3_BasicTest_3states_MPC_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_CART3_BasicTest_3states_MPC_method_dispatcher(SimStruct
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"CART3_BasicTest_3states_MPC")) {
    return(sf_CART3_BasicTest_3states_MPC_method_dispatcher(simstructPtr,
...
extern void CART3_BasicTest_3states_MPC_terminator(void);
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    CART3_BasicTest_3states_MPC_terminator();
    mpclib_terminator();
...
extern void CART3_BasicTest_3states_MPC_initializer(void);
extern void mpclib_initializer(void);
extern void CART3_BasicTest_3states_MPC_register_exported_symbols(SimStruct* S);
extern void mpclib_register_exported_symbols(SimStruct* S);
extern void CART3_BasicTest_3states_MPC_debug_initialize(struct
...
{
  CART3_BasicTest_3states_MPC_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      CART3_BasicTest_3states_MPC_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    CART3_BasicTest_3states_MPC_initializer();
    if (!simModeIsRTWGen) {
