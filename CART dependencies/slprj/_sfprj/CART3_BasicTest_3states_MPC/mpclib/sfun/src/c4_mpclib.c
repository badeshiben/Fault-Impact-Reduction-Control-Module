  ...
  *c4_inData)
{
  ...
  for (c4_i12 = 0; c4_i12 < 11; c4_i12++) {
    c4_b_inData[c4_i12] = (*(real_T (*)[11])c4_inData)[c4_i12];
  }

  for (c4_i13 = 0; c4_i13 < 11; c4_i13++) {
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i14 = 0; c4_i14 < 11; c4_i14++) {
    (*(real_T (*)[11])c4_outData)[c4_i14] = c4_y[c4_i14];
  }
  ...
  *c4_inData)
{
  ...
  for (c4_i15 = 0; c4_i15 < 10; c4_i15++) {
    c4_b_inData[c4_i15] = (*(real_T (*)[10])c4_inData)[c4_i15];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i17 = 0; c4_i17 < 10; c4_i17++) {
    (*(real_T (*)[10])c4_outData)[c4_i17] = c4_y[c4_i17];
  }
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[10])
{
  ...
  int32_T c4_i18;
  (void)chartInstance;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv4, 1, 0, 0U, 1, 0U, 1, 10);
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[11])
{
  ...
  int32_T c4_i19;
  (void)chartInstance;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv5, 1, 0, 0U, 1, 0U, 1, 11);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1074316255U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1975552589U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(996159187U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2961493236U);
}
...
mxArray *sf_c4_mpclib_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("lb7vbBn3ZZVraQvc4ScTTG");
...
static void mdlSetWorkWidths_c4_mpclib(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3590620838U));
  ssSetChecksum1(S,(2072492744U));
  ssSetChecksum2(S,(2406500541U));
  ssSetChecksum3(S,(1347189994U));
