  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"mpclib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1555252839U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3468686134U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3618905984U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(256577936U);
        } else if (nrhs==4) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(aiChksum, "v3akfLbyuOwiuwjZmA2shF") == 0) {
     ...
     case 4:
      {
        if (strcmp(aiChksum, "lb7vbBn3ZZVraQvc4ScTTG") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "vGjdtZULg2jztxeAMGCzzC") == 0) {
     ...
     case 4:
      {
        if (strcmp(tpChksum, "kQjoIkIvhyJK71rPXOkkkH") == 0) {
